...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified option1;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified option2;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified option3;
- (void)viewDidLoad;
- (void)updateUI;
- (IBAction)responseBtnPressed:(UIButton * _Nonnull)sender;
